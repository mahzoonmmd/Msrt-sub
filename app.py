...
class OnboardingDialog(QDialog):
    ...
    def _build(self):
        ...
        lay.addSpacing(16)
        self.title_lbl=QLabel(); self.title_lbl.setFont(QFont("Segoe UI",18,QFont.Weight.Bold))
        ...
        self.body_lbl.setStyleSheet(f"color:{t('sub')};line-height:1.8")
        self.body_lbl.setAlignment(Qt.AlignmentFlag.AlignRight|Qt.AlignmentFlag.AlignVCenter)
